        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessModules_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessModules_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreOrders_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreOrders_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomeExpenses_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaFiles_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_BusinessId",
                table: "ActivityLogs",
                column: "BusinessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessModules_BusinessId",
                table: "BusinessModules",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessModules_ModuleId",
                table: "BusinessModules",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeExpenses_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreOrders_BusinessId",
                table: "StoreOrders",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreOrders_ModuleId",
                table: "StoreOrders",
                column: "ModuleId");
